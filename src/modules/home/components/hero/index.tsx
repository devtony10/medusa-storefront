      ...
      <div className="main-wrapper">
        <article className="css-940b0i e1gathm31">
          ...
          <h1 className="headline">
            <strong>PureVis™ 2 is live.</strong>
          </h1>
          <div className="description">
            Purify. Track. Self-cleaning. This is the smart water bottle the
            world’s been waiting for.
          </div>
          <a
            href="/purification/larq-bottle-purevis-2"
        ...
        <div className="main-wrapper_right">
          <article className="css-r5lz8t e19brqgm0">
            <a
              className="product-card_inner"
              href="/purification/larq-bottle-purevis-2?sku=BWEG100A"
            >
              <img
                src="https://res.cloudinary.com/larq/image/upload/q_auto,f_auto/w_900/v1710408035/SKU/SPA/v3/BWEG100A.png"
                className="product-card_product-image"
                loading="lazy"
              />
              <h6 className="product-card_name">LARQ Bottle PureVis™ 2</h6>
            </a>
          </article>
        </div>
      </div>
