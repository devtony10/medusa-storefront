export default async function Rating() {
    return (
        <div className="rating">
            <div className="reviewsFeatured_ratingStars css-1ifxqp3 eypye2w0" aria-label="Rated 4.6 out of 5 stars">
                <h3 className="rating-title">Brilliant</h3>
                <ul className="rating-stars">
                    <li>
                        <svg viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg" role="img">
                ...
                <a className="rating-total" href="/purification/larq-bottle-purevis/reviews">
                    based on 11781 reviews
                </a>
            </div>
            <a href="/purification/larq-bottle-purevis/reviews" className="all-reviews-button css-1ezy16c edhpqag0" tabIndex={0}>
                All reviews{/* */}{" "}
                <span>
